package tng.springframework.recipe.bootstrap;

import tng.springframework.recipe.domain.*;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent>{
	...
	@Override
	@Transactional // application event . spring fw create a transaction around this method, so now everythings is going to happen in the same transactional
	...
	private List<Recipe> getRecipes(){
        ...
        guacRecipe.setSourse("Simply recipe");
        ...
        tacosRecipe.setSourse("Quick marinade, then grill");
